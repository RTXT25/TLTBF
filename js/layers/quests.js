    ...
    challenges: {
        ...
        18: {
            ...
            goal(){
                ...
                if (challengeCompletions(this.layer, this.id) == 27) return new Decimal(43);
                if (challengeCompletions(this.layer, this.id) == 28) return new Decimal(46);
                if (challengeCompletions(this.layer, this.id) == 29) return new Decimal(50);
                if (challengeCompletions(this.layer, this.id) == 30) return new Decimal(55);
                if (challengeCompletions(this.layer, this.id) == 31) return new Decimal(60);
                if (challengeCompletions(this.layer, this.id) == 32) return new Decimal(67);
                if (challengeCompletions(this.layer, this.id) == 33) return new Decimal(73);
                if (challengeCompletions(this.layer, this.id) == 34) return new Decimal(80);
