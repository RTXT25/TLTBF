addLayer("g", {
    ...
    upgrades: {
        ...
        11: {
            ...
            cost() { return new Decimal(5000).pow(layers.g.costDecrement()) },
        ...
        12: {
            ...
            cost() { return new Decimal(50000).pow(layers.g.costDecrement()) },
        ...
        13: {
            ...
            cost() { return new Decimal(1e6).pow(layers.g.costDecrement()) },
        ...
        15: {
            ...
            cost() { return new Decimal(42).pow(layers.g.costDecrement()).times((hasMilestone("s", 6) ? 0 : 1)) },
        ...
        21: {
            ...
            cost() { return new Decimal(1e12).pow(layers.g.costDecrement()) },
        ...
        22: {
            ...
            cost() { return new Decimal(5e13).pow(layers.g.costDecrement()) },
        ...
        24: {
            ...
            cost() { return new Decimal(4e16).pow(layers.g.costDecrement()) },
        ...
        25: {
            ...
            cost() { return new Decimal(3e17).pow(layers.g.costDecrement()) },
